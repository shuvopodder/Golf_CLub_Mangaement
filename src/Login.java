    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if(n==3){
                    JOptionPane.showMessageDialog(null, "You Entered Wrong information 3 times!\nWant To Recover Pasword?", "Wrong!!!", JOptionPane.ERROR_MESSAGE);

                    Password_Recover obj = new Password_Recover();
                    obj.setVisible(true);
                }
            }
